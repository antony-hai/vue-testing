    ...
    <tr>
      <td>
        ...
        <StanceTable hasTop hasBottom>
          ...
          <tr height='10'></tr>
          <tr>
            <td style="font-size:12px;text-align: left; font-family: 微软雅黑; line-height: 22px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 您好！非常感谢贵公司一直以来对英特尔的大力支持！特此告知您2018年第四季度搭载Windows<Sup></Sup>10的英特尔<Sup></Sup>NUC 迷你电脑促销奖励计划，如下：</td>
          </tr>
        </StanceTable>
        ...
        <StanceTable>
          ...
          <tr>
            ...
            <TCell>本促销活动有效期为2018年10月21日至2018年12月31日（“促销活动时间”），适用对象为中华人民共和国（仅为本促销条款的目的，系指不包括香港、澳门和台湾的境内地区）的英特尔<Sup></Sup>技术合作伙伴中已激活的至尊会员及菁英会员（“合格会员”）。</TCell>
          </tr>
          <tr>
            <TCell width="25">3.</TCell>
            <TCell>在促销活动期间，对合格会员从英特尔<Sup></Sup>授权总代理（“IAD”）、英特尔<Sup></Sup>授权集成供应商（“IACS”）或英特尔<Sup></Sup>认可供应商（“IAS”） [视具体情况而定]购买如下列表中的英特尔产品（“符合条件的英特尔<Sup></Sup>产品”），英特尔将实行以下积分奖励：</TCell>
          </tr>
        </StanceTable>
        ...
        <StanceTable hasTop>
          <tr>
            <td>
              <DataTable :dataSource="tableData1" :column="column1"></DataTable>
            </td>
          </tr>
          <tr height="30"></tr>
          <tr>
            <td>
              <DataTable :dataSource="tableData2" :column="column2" Talign="left"></DataTable>              
            </td>
          </tr>
        ...
        <StanceTable hasTop>
          <tr>
            ...
            <TCell>
              在此次促销活动中，购买参与活动英特尔产品的积分赚取日期为购买英特尔产品的发票开具日期。英特尔将在促销结束后60（六十）天内，根据规则，向符合条件且遵守各项规则的合作伙伴发放在本次促销活动中奖励的积分。
            </TCell>
          </tr>          
          <tr>
            ...
            <TCell>
              合格会员将：
              <ListTable :dataSource="dataSource1" width="608" isLetter></ListTable>
            </TCell>
          </tr>
          <tr>
            ...
            <TCell>
              ...
              <ListTable :dataSource="dataSource2" width="608" isLetter></ListTable>
            </TCell>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <TCell>
              本促销条款中未另行定义的大写术语与在ITP项目条款中的大写术语具有相同含义。
            </TCell>
          </tr>
          <tr>
            <TCell width="25">9.</TCell>
            <TCell>合格会员接受本促销活动中的积分表示您接受此促销活动条款和条件。</TCell>
          </tr>
          <tr>
            <TCell width="25">10.</TCell>
            <TCell>英特尔保留以任何形式通知客户的方式，随时修改、暂停或终止此次促销活动的权利，且上述修改、暂停或终止应立即生效，但不影响促销活动中已累积的任何权益，除此之外英特尔不因上述修改、暂停或终止而承担任何责任。</TCell>
          </tr>
          <tr>
            <TCell width="25">11.</TCell>
            <TCell>依照英特尔的网站使用条款<a href="https://www.intel.cn/content/www/cn/zh/legal/terms-of-use.html" target="_blank">（https://www.intel.cn/content/www/cn/zh/legal/terms-of-use.html）</a>，凡以您的账户在英特尔网站上进行的操作，均视为您的操作并由您负责；如果您的账户、密码等信息有误或发生泄露，导致您的权益受损，请理解英特尔将不承担任何责任。</TCell>
          </tr>
        </StanceTable>
        ...
        <StanceTable hasTop hasBottom>
          ...
          <tr>
            <TCell :ostyle="{ 'font-size': '13px', 'font-weight': '600'}">
             Intel<Sup></Sup> NUC a Mini PC with Windows<Sup></Sup> 10 (“Promotion”)Terms and Conditions 
            </TCell>
          </tr>
          <tr height="10"></tr>
        </StanceTable>
        ...
        <StanceTable>
          ...
          <tr>
            <TCell width="25">2.</TCell>
            <TCell>
              This Promotion is effective from October 21st, 2018 until December 31st, 2018 (the “Promotion Period”) and available to active Platinum, and Gold partners of Intel<Sup></Sup> Technology Provider in the People’s Republic of China (excluding Hong Kong, Macao and Taiwan, for the purpose of the Promotion Terms) (“Eligible Partners”). 
            </TCell>
          </tr>
          <tr>
            <TCell width="25">3.</TCell>
            <TCell>3.Intel will award Eligible Partners the following Points per unit for purchases of the Intel products listed below (“Qualifying Intel Products”) from an Intel® Authorized Distributor (“IAD”), Intel Authorized Component Supplier (“IACS”), or Intel® Approved Supplier (“IAS”) [where applicable] during the Promotion Period:</TCell>
          </tr>
        </StanceTable>
        ...
        <StanceTable hasTop>
          <tr>
            <td>
              <DataTable :dataSource="tableData11" :column="column11"></DataTable>
            </td>
          </tr>
          <tr height="30"></tr>
          <tr>
        ...
        <StanceTable hasTop hasBottom>
          ...
          <tr>
            ...
            <TCell>
              ...
              <ListTable :dataSource="dataSource3" width="608" isLetter></ListTable>
            </TCell>
          </tr>
          <tr>
            <TCell width="25">6.</TCell>
          ...
          <tr>
            <TCell width="25">8.</TCell>
            <TCell>
              Capitalized terms which are not defined in these Promotion Terms shall have the meaning given to them in the ITP Program Terms.
            </TCell>
          </tr>
          <tr>
            <TCell width="25">9.</TCell>
          ...
          <tr>
            <TCell width="25">10.</TCell>
            <TCell>Intel reserves the right to modify, suspend or terminate the Promotion at any time and for any reason with immediate effect, without prejudice to any rights that have already accrued under the Promotion but with no further liability, by giving notice in any form to Customer.</TCell>
          </tr>
          <tr>
            <TCell width="25">11.</TCell>
            <TCell>In accordance with Intel Terms of Use<a href="https://www.intel.cn/content/www/cn/zh/legal/terms-of-use.html" target="_blank">（https://www.intel.cn/content/www/cn/zh/legal/terms-of-use.html）</a>，you are entirely responsible for any and all activities that occur under your account at any Intel web site, and Intel will not be liable for any loss that you may incur as a result of any error in the information provided by you with regard to your account or password, or as a result of someone else using your account or password.</TCell>
          </tr>
        </StanceTable>
...
const dataSource1 = [
  ...
  { text: "不可以变现此次促销活动中赚取的积分。" }
];
const dataSource2 = [
  { text: "撤销合格会员在此次促销活动中原可获得的积分奖励；" },
  {
    text: "调整合格会员在此次促销活动中获取积分奖励的数额；"
  },
  { text: "不允许您兑换在此次促销活动中获取的奖励积分；" },
  { text: "用合格会员现有的积分或未来赚取的积分抵销合格会员通过此次促销活动赚取并已用于兑换的全部（或部分）奖励积分；并且/或" },
  { text: "索回合格会员在本次促销活动中赚取的且已用于兑换的全部（或部分）奖励积分之价值。" }
];
const dataSource3 = [
  {
    text:"earn unlimited points under this Promotion;"
  },
  {
    text: "combine this Promotion with other Points offers;"
  },
  { text: "will not combine this Promotion with other discounts or promotions on Qualifying Intel Products whether offered to the Eligible Partner, or to a third party on its behalf, as notified by Intel;" },
...
const tableData1 = [
  {"text1":"1-5","text2":"每单位30积分"},{"text1":"6-15","text2":"每单位40积分"},{"text1":"16-30","text2":"每单位50积分"},{"text1":"31-50","text2":"每单位60积分"},{"text1":"51-100","text2":"每单位70积分"},{"text1":"101+","text2":"每单位80积分"}
]
const tableData11 = [
